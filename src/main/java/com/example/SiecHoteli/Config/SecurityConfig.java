    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/reserv/add").hasAnyAuthority(Role.ADMIN.name(),Role.USER.name())
                        .requestMatchers("/api/v1/reserv/getAll").hasAnyAuthority(Role.ADMIN.name(),Role.USER.name())
                        .requestMatchers(HttpMethod.GET, "/api/v1/rooms").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/reserv/getFree").permitAll()
