    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/reserv/add").hasAuthority(Role.USER.name())
                        .requestMatchers("/api/v1/hotels/add", "/api/v1/hotels/delete", "/api/v1/hotels/update").hasAuthority(Role.ADMIN.name())
                        .requestMatchers("/api/v1/reserv/add", "/api/v1/reserv/delete", "/api/v1/reserv/update","/api/v1/reserv/deleteExpired").hasAuthority(Role.ADMIN.name())
